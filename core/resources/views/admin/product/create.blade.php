                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="number" step=".01" name="price" min="0" class="form-control" value="{{ old('price') }}" required />
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="number" step=".01" class="form-control" name="discount" min="0" value="{{ old('discount') }}">
